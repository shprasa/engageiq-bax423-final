...
**Student:** Shivneel Prasad · **Updated:** June 5, 2026
...
| ≥10,000 offline records | All 15 domains | ✅ | 10,944 rows, 15/15 domains |
| ≥2 BAX-423 techniques | Different lectures, benchmarked | ✅ | Recommendation + RL |
| 4 personas + pass/fail table | In brief.pdf | ✅ | Section 7–8 in brief.pdf |
| prompts.md | Key AI prompts | ✅ | Updated for GitHub API + GH Archive |
...
|-------------------|--------|----------|
| ≥2 data sources | ✅ | GitHub API (4,944) + GitHub Archive (6,000) |
...
| Measurable improvement | ✅ | Reward 1.0 vs 0.3 (last-10 avg) |
...
| Suggested actions | ✅ | Gemini/Groq/templates |
...
- [ ] Redeploy Streamlit Cloud after latest push (verify GH Archive UI)
- [ ] Optional: set `GEMINI_API_KEY` in Streamlit secrets
